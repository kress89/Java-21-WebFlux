...
public class DroolsAutoConfiguration {
  ...
  public KieContainer kieContainer() throws IOException {
    ...
    if (kieBuilder.getResults().hasMessages(Message.Level.ERROR)) {
      throw new IllegalStateException("Error building KieBase: " + kieBuilder.getResults().toString());
    }
    return getKieServices().newKieContainer(kieBuilder.getKieModule().getReleaseId());
  }
